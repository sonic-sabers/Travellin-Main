 ...
 */
export declare function useInterpolateMotiPressable<Props>(id: MotiPressableInteractionIds['id'], factory: Factory<Props>, deps?: Deps): Readonly<SharedValue<Props>>;
export declare function useInterpolateMotiPressable<Props>(factory: Factory<Props>, deps?: Deps): Readonly<SharedValue<Props>>;
export {};
