...
export type Transforms = PerpectiveTransform & RotateTransform & RotateXTransform & RotateYTransform & RotateZTransform & ScaleTransform & ScaleXTransform & ScaleYTransform & TranslateXTransform & TranslateYTransform & SkewXTransform & SkewYTransform;
...
export type SequenceItem<Value> = // raw style values
...
export type StyleValueWithSequenceArrays<T> = Partial<StyleValueWithSequenceArraysWithoutTransform<T> & StyleValueWithSequenceArraysWithTransform>;
...
export type Variants<V, AnimateType = ImageStyle & TextStyle & ViewStyle, AnimateWithTransformsAndTransition = StyleValueWithReplacedTransforms<AnimateType> & WithTransition, Animate = StyleValueWithSequenceArrays<AnimateWithTransformsAndTransition>> = {
...
export type UseAnimationStateConfig<Variants, FromKey extends keyof Variants = keyof Variants, ToKey extends keyof Variants = keyof Variants> = {
    /**
 ...
 */
export type DynamicStyleProp<AnimateType = ImageStyle & ViewStyle & TextStyle, AnimateWithTransforms = StyleValueWithReplacedTransforms<AnimateType>> = NonNullable<StyleValueWithSequenceArrays<AnimateWithTransforms>> & WithTransition;
