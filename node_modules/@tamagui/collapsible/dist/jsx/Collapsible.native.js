...
const CONTENT_NAME = "CollapsibleContent", CollapsibleContentFrame = styled(Stack, {
  ...
  return <AnimatePresence {...contentProps}>{forceMount || context.open ? <CollapsibleContentFrame ref={forwardedRef} {...contentProps}><ResetPresence>{children}</ResetPresence></CollapsibleContentFrame> : null}</AnimatePresence>;
});
