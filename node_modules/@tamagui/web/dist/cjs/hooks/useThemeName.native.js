...
function useThemeName(opts) {
  const manager = (0, import_useTheme.getThemeManager)((0, import_react.useContext)(import_ThemeManagerContext.ThemeManagerIDContext)), [name, setName] = (0, import_react.useState)((manager == null ? void 0 : manager.state.name) || "");
  return (0, import_constants.useIsomorphicLayoutEffect)(() => {
    if (manager)
      return setName(manager.state.name), manager.onChangeTheme((next, manager2) => {
        const name2 = opts != null && opts.parent && manager2.state.parentName || next;
        name2 && setName(name2);
      });
