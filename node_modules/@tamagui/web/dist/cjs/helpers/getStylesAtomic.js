...
var import_helpers = require("@tamagui/helpers"), import_config = require("../config"), import_defaultOffset = require("./defaultOffset"), import_normalizeValueWithProperty = require("./normalizeValueWithProperty"), import_pseudoDescriptors = require("./pseudoDescriptors"), import_normalizeColor = require("./normalizeColor");
...
function createAtomicRules(identifier, property, value, pseudo) {
  const selector = pseudo ? pseudo != null && pseudo.selector ? `${pseudo == null ? void 0 : pseudo.selector} .${identifier}` : `${selectorPriority[pseudo.name]} .${identifier}:${pseudo.name}` : `:root .${identifier}`, important = !!pseudo;
  let rules = [];
  switch (property) {
