...
function Popper(props) {
  ...
  }, [anchorRef]), import_constants.isWeb)
    (0, import_constants.useIsomorphicLayoutEffect)(() => {
...
const PopperAnchor = import_stacks.YStack.extractable(
  ...
  const { __scopePopper, enableAnimationForPositionChange, ...rest } = props, { strategy, placement, refs, x, y, getFloatingProps, size, isMounted, update } = usePopperContext(__scopePopper), contentRefs = (0, import_compose_refs.useComposedRefs)(refs.setFloating, forwardedRef), contents = React.useMemo(() => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    PopperContentFrame,
    {
  ...
  if (primaryPlacement) {
    ...
    oppSide && (arrowStyle[oppSide] = -size, innerArrowStyle[oppSide] = size / 2), oppSide === "bottom" && (arrowStyle[oppSide] += 1), (oppSide === "top" || oppSide === "bottom") && (arrowStyle.left = 0), (oppSide === "left" || oppSide === "right") && (arrowStyle.top = 0), (0, import_constants.useIsomorphicLayoutEffect)(() => {
      var _a2;
