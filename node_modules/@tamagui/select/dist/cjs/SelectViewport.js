...
var import_react = require("@floating-ui/react"), import_animate_presence = require("@tamagui/animate-presence"), import_compose_refs = require("@tamagui/compose-refs"), import_constants = require("@tamagui/constants"), import_constants2 = require("@tamagui/constants"), import_core = require("@tamagui/core"), import_portal = require("@tamagui/portal"), import_stacks = require("@tamagui/stacks"), import_constants3 = require("./constants"), import_context = require("./context"), import_useSelectBreakpointActive = require("./useSelectBreakpointActive"), import_jsx_runtime = require("react/jsx-runtime");
const SelectViewportFrame = (0, import_core.styled)(import_stacks.ThemeableStack, {
  name: import_constants3.VIEWPORT_NAME,
  variants: {
    unstyled: {
      false: {
        size: "$2",
