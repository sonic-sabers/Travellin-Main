...
const SelectInlineImpl = (props) => {
  ...
  const flipOrShiftMiddlewares = [
    touch ? (0, import_react.shift)({ crossAxis: !0, padding: import_constants2.WINDOW_PADDING }) : (0, import_react.flip)({ padding: import_constants2.WINDOW_PADDING })
  ...
  const floatingRef = refs.floating, showUpArrow = open && scrollTop > import_constants2.SCROLL_ARROW_THRESHOLD, showDownArrow = open && floatingRef.current && scrollTop < floatingRef.current.scrollHeight - floatingRef.current.clientHeight - import_constants2.SCROLL_ARROW_THRESHOLD, onMatch = (0, import_core.useEvent)((index) => (open ? setActiveIndex : setSelectedIndex)(index)), interactionsProps = [
